...
async def autopilot():
    ...
    if isinstance(chat.photo, ChatPhotoEmpty):
        photo, _ = await download_file(
            "https://graph.org/file/81927f6473bca35a5ad53.jpg"
        )
...
async def customize():
    ...
    try:
        ...
        await ultroid_bot.send_message(
            "botfather",
            f"✨ Powerful Radha Userbot Assistant Bot ✨\n✨ Master ~ {sir} ✨\n\n✨ Powered By ~ @RadhaX2Support ✨",
        )
        await asyncio.sleep(2)
...
async def ready():
    ...
    if not udB.get_key("INIT_DEPLOY"):  # Detailed Message at Initial Deploy
        MSG = """🎇 **Thanks for Deploying Radha Userbot!**
• Here, are the Some Basic stuff from, where you can Know, about its Usage."""
        PHOTO = "https://graph.org/file/81927f6473bca35a5ad53.jpg"
        BTTS = Button.inline("• Click to Start •", "initft_2")
        udB.set_key("INIT_DEPLOY", "Done")
    else:
        MSG = f"**Ultroid has been deployed!**\n➖➖➖➖➖➖➖➖➖➖\n**UserMode**: {inline_mention(ultroid_bot.me)}\n**Assistant**: @{asst.me.username}\n➖➖➖➖➖➖➖➖➖➖\n**Support**: @RadhaX2Support\n➖➖➖➖➖➖➖➖➖➖"
